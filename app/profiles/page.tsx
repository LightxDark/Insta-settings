                ...
                <section className="  py-4 w-2/3 space-y-4">
                    ...
                    <div className=" cursor-pointer border rounded-3xl">
                        <div className="flex p-4 hover:bg-gray-200 ">
                            <Image src="https://preview.redd.it/9tufcn9pmxz41.png?auto=webp&s=89313bc19d1506ea7860551ad6c989cde6e8140c" alt=""  width={32} height={32} className="rounded-full w-1/12"/>
